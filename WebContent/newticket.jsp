				...
				<td width="100%" align="center" valign="center" border="0" bgcolor="#FFFFFF">
                		...
                		<table width="95%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td class="searchField" width="50%" align="left"><img src="images/lookup-icon.gif" width="20" height="14" title="check if donor exists" alt="check if donor exists" /></td>
                            </tr>    
                        ...
                        <table width="95%" cellpadding="0" cellspacing="0" border="0">
                         ...
                         <table width="95%" cellpadding="0" cellspacing="0" border="0">
                        	<tr>
                            	<td width="5" class="fieldHeading" ><input type="checkbox" name="elevatorFlag" value="Y" <% if (DispatchServlet.getAddress().getElevatorFlag().equals("Y")) {%>checked<%}%>/></td>
                                <td class="fieldHeading" >Check if elevator access is available</td>
                            </tr> 
                            <tr>
                            	<td width="5" class="fieldHeading" ><input type="checkbox" name="gateFlag" value="Y" <% if (DispatchServlet.getAddress().getGateFlag().equals("Y")) {%>checked<%}%>/></td>
                            ...
                            <tr>
                                <td colspan="2" class="fieldHeading" >
                                    ...
                                    %>
                                	 <select name="gateInstructions"  class="ddl">
                                    <option value="">
                                    <%
                                    if (ddl!=null) {
                                      for (int j=0;j<ddl.size();j++) {
